<template>
  <div class="xgboost-result" v-if="datasetDetails.resultMethod === 'xgboost' || datasetDetails.method === 'xgboost_classification' || datasetDetails.method === 'xgboost_regression'">
    <h3>XGBoost分析结果</h3>
    ...
    <div class="info-grid">
      ...
      <div class="info-item" v-if="datasetDetails.objective">
        <span class="info-label">目标函数:</span>
        <span class="info-value">{{ datasetDetails.objective }}</span>
      </div>
      <div class="info-item">
    ...
    <div class="stats-summary-container">
      <table class="stats-summary-table" ref="paramsTable">
        ...
        <tbody>
          <tr>
            <td>树的数量</td>
            <td>{{ datasetDetails.model_params.n_estimators }}</td>
          </tr>
          <tr>
            <td>树的最大深度</td>
          ...
          <tr>
            <td>学习率</td>
            <td>{{ datasetDetails.model_params.learning_rate }}</td>
          </tr>
          <tr>
            <td>子样本比例</td>
            <td>{{ datasetDetails.model_params.subsample }}</td>
          </tr>
          <tr>
            <td>每棵树特征比例</td>
            <td>{{ datasetDetails.model_params.colsample_bytree }}</td>
          </tr>
          <tr>
            <td>随机种子</td>
...
export default {
  ...
  computed: {
    isClassification() {
      return this.datasetDetails.method === 'xgboost_classification' || 
